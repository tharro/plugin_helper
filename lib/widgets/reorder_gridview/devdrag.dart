...
import 'package:plugin_helper/widgets/reorder_gridview/gridorbiter.dart';

class MyWidgetDragAndDropGridView extends MainGridView {
  ...
  const MyWidgetDragAndDropGridView({
    Key? key,
    bool reverse = false,
    Widget? header,
  ...
  /// [onWillAccept] this funciton allows you to validate if you want to accept the change in the order of the gridViewItems.
  ///  If you always want to accept the change simply return true
  const MyWidgetDragAndDropGridView.horizontal({
    Key? key,
    bool reverse = false,
    ScrollController? controller,
    bool? primary,
  ...
  /// [onWillAccept] this funciton allows you to validate if you want to accept the change in the order of the gridViewItems.
  ///  If you always want to accept the change simply return true
  const MyWidgetDragAndDropGridView.stickyHeader({
    Key? key,
    bool reverse = false,
    ScrollController? controller,
    bool? primary,
  ...
  /// [onWillAccept] this funciton allows you to validate if you want to accept the change in the order of the gridViewItems.
  ///  If you always want to accept the change simply return true
  const MyWidgetDragAndDropGridView.horizontalStickyHeader({
    Key? key,
    bool reverse = false,
    ScrollController? controller,
    bool? primary,
