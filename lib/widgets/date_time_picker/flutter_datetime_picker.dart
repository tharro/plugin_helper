...
class _DatePickerRoute<T> extends PopupRoute<T> {
  _DatePickerRoute({
    ...
    BasePickerModel? pickerModel,
        ...
        theme = theme ?? const DatePickerCustomTheme(),
...
//    print('refreshScrollOffset ${widget.pickerModel.currentRightIndex()}');
  ...
  Widget build(BuildContext context) {
    DatePickerCustomTheme theme = widget.route.theme;
  ...
  Widget _renderPickerView(DatePickerCustomTheme theme) {
  ...
  Widget _renderItemView(DatePickerCustomTheme theme) {
    return Container(
      color: theme.backgroundColor,
  ...
  // Title View
  Widget _renderTitleActionsView(DatePickerCustomTheme theme) {
