...
class MyWidgetLinearPercentIndicator extends StatefulWidget {
  ...
  MyWidgetLinearPercentIndicator({
    Key? key,
  ...
  @override
  _MyWidgetLinearPercentIndicatorState createState() =>
      _MyWidgetLinearPercentIndicatorState();
}

class _MyWidgetLinearPercentIndicatorState
    extends State<MyWidgetLinearPercentIndicator>
  ...
  void _checkIfNeedCancelAnimation(MyWidgetLinearPercentIndicator oldWidget) {
  ...
  @override
  void didUpdateWidget(MyWidgetLinearPercentIndicator oldWidget) {
